...
In the spirit of "the source of truth will set you free" I did a quick test of the timing difference between using attributes as the "source of truth" vs a property, focusing first on the most "borderline" case -- where the property is of type number.  The results are [in line](https://github.com/bahrus/xtal-element/blob/baseline/demo/misc/numberAttribTest.html) with what I expected:
...
## A registry of custom attribute parsers + reflectors => handlers?
...
class ClubMember extends HTMLElement{
    static observedAttributes = [
        ...
        {
            name: 'UrlLinkToFavoriteNovel',
            mapsTo: 'pithyQuote',
            handler:  MyNonRegisteredCustomAttributeClassHandlerConstructorThatUsesAIToPullACatchyQuoteFromTheNovelAndCachesIt
        }
    ]
}
```
