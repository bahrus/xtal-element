...
/* html */ `<div></div>`);
let CounterXtalRoomWithAView = /** @class */ (() => {
    class CounterXtalRoomWithAView extends XtalRoomWithAView {
        constructor() {
            super(...arguments);
    ...
    return CounterXtalRoomWithAView;
})();
export { CounterXtalRoomWithAView };
